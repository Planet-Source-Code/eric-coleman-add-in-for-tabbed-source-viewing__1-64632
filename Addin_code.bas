...
Public gButtonVisibleIndex As Long
Public gCountControlButtons As Long

Public gVBE As VBIDE.VBE
Public gWindow  As VBIDE.Window    'used to make sure we only run one instance
'Public gEvents As Events
'public gDocWindow As Object          'user doc object
